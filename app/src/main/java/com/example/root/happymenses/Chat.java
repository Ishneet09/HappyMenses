...
public class Chat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_cwd);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Chat.this, Register_cwd.class));
            }
        });
                            ...
                            if(s.equals("null")){
                                ...
                                try {
                                    ...
                                    if(!obj.has(user)){
                                        ...
                                        UserDetails_cwd.username = user;
                                        UserDetails_cwd.password = pass;
                                        startActivity(new Intent(Chat.this, Users_cwd.class));
                                    }
                                    else {
